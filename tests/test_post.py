...
class TestPost:
    ...
    def test_post_with_single_site(self, site):
        ...
        """
        print(site)
        os.system(f'python app.py {self.test_file} -co static/imgs/logo.png -s {site}')
    ...
    def test_post_with_sites(self,sites):
        ...
        :return:
        """
        order = f'python app.py {self.test_file} -co static/imgs/logo.png -s {sites}'
        os.system(order)
        print(order)
    ...
    def test_post_with_sites_and_tags(self,tags):
        ...
        :return:
        """
        os.system(f'python app.py {self.test_file} -co static/imgs/logo.png -s juejin csdn -t {tags}')
